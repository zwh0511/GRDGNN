...
def LoadData(args, location="pred"):
    ...
    Dream_Pear_train_P = GRDGrahp(root=root_path, dataset_type=dataset_type, network_type="Pearson",
                                  scGRN_type=scGRN_type, cross_val_location=location,
    ...
    Dream_Pear_test_P = GRDGrahp(root=root_path, dataset_type=dataset_type, network_type="Pearson",
                                 scGRN_type=scGRN_type, cross_val_location=location,
                                 dataset_name=dataset_name, threshold=threshold, hop=hop, max_nodes_per_hop=10,
