...
import tqdm
from code.Transductive.BinaryClassification.DREAM5 import node2vec
...
def SVM_RF_genenet_attribute(allx, tfNum):
    ...
    #
    # quantilPerAtt = np.concatenate([qu1Att, qu2Att, qu3Att, qu4Att, qu5Att, qu6Att, qu7Att, qu8Att, qu9Att, qu10Att],
    #                                axis=1)
    # quantilValAtt = np.concatenate(
    #     [minVal, qu1Val, qu2Val, qu3Val, qu4Val, qu5Val, qu6Val, qu7Val, qu8Val, qu9Val, maxVal], axis=1)
    #
    # # 5: TF or not, vital
    ...
    # trainAttributes = np.concatenate([trainAttributes, stdAtt, qu1Att, qu3Att, tfAttr, quantilValAtt], axis=1)
