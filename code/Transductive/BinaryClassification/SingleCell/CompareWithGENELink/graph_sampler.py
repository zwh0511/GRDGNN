...
from code.Transductive.BinaryClassification.SingleCell.CompareWithGENELink.units import cmd_args
...
class GRUDGrahp(Dataset):
    def __init__(self, root='/root/undergraduate/guozydata/expression2GRN', dataset_type='dream',
